...
const SearchResult = React.memo(({
  ...
  const getFont = useCallback(
    () => getTextFont({ font, isOriginal, languageId, bookId }),
    [ font, isOriginal, languageId, bookId ],
  )

  const getJSXFromPieces = useCallback(
    ({ pieces }) => {
    ...
    [ searchString, textSize, lineSpacing, theme, languageId, isOriginal, bookId, getFont ],
  )
