  ...
  const getJSXFromPieces = ({ pieces, doSmallCaps }) => {
    ...
    return pieces.map((piece, idx) => {
      ...
      if(textPieces.length > 0) {
        ...
        return getPartOfPiece(adjustedText)
      }
...
export default memo(connect(mapStateToProps, matchDispatchToProps)(Verse), { name: 'Verse', jsonMemoProps: [ 'style', 'passageRef', 'matchStyle' ] })